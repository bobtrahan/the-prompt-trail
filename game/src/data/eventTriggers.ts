...
export const EVENT_SCHEDULE: DayEventSchedule[] = [
  { day: 1,  afterPrompts: [2] },             // 1 event  / 4 prompts
  { day: 2,  afterPrompts: [2] },             // 1 event  / 4 prompts
  { day: 3,  afterPrompts: [2, 3] },          // 2 events / 4 prompts
  ...
  { day: 8,  afterPrompts: [2, 3, 5] },       // 3 events / 6 prompts
  { day: 9,  afterPrompts: [2, 3, 5] },       // 3 events / 7 prompts
  { day: 10, afterPrompts: [2, 4, 6] },       // 3 events / 8 prompts
  { day: 11, afterPrompts: [2, 4, 6, 7] },    // 4 events / 8 prompts
  { day: 12, afterPrompts: [2, 4, 6, 7, 8] }, // 5 events / 9 prompts
  { day: 13, afterPrompts: [2, 3, 5, 6, 8, 9] }, // 6 events / 10 prompts
];
